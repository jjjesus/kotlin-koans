...
// JJJ: extend the Int class by adding an r() function that returns a RationalNumber
//
fun Int.r(): RationalNumber = Pair(this,1).r()

// JJJ: extend the Pair class by adding an r() function that returns a RationalNumber
//
