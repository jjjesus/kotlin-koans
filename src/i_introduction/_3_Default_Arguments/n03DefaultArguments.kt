...
// JJJ: Let the compiler errors help to build the function
// Shortcut for returning or converting a string inline
//
fun foo(name: String, number: Int = 42, toUpperCase: Boolean = false): String {
    if (!toUpperCase) return name + number
    else return name.toUpperCase() + number
